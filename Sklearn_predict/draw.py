...
train_sizes, train_scores, test_scores, fit_times, _ = learning_curve((knn_model), X, y, cv=30,return_times=True)
plt.figure()
print(fit_times.shape,train_scores.shape)
plt.plot(fit_times,train_scores)
plt.show()
exit(0)
